...
>(({ className, children, error, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex h-11 w-full items-center justify-between rounded-lg border bg-white px-4 py-2 text-sm shadow-sm',
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            'focus:bg-indigo-50 focus:text-indigo-900 dark:focus:bg-indigo-900/20 dark:focus:text-indigo-300',
